...
import com.dicoding.storyapp.database.room.RemoteKeys
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        wrapEspressoIdlingResource {
            try {
                Log.d("LOKASI", locationTest.toString())
                val responseData = apiService.testAllStories(token, page, state.config.pageSize, locationTest)
                val data = responseData.listStory
                Log.d("Lelah", responseData.toString())
                ...
                Log.d("xixixixi", exception.message.toString())
